...
const upiConfig = {
  phonePe: "netc.34161fa820328aa2caf45240@mairtel",
  paytm: "netc.34161fa820328aa2caf45240@mairtel",
  googlePay: "netc.34161fa820328aa2caf45240@mairtel"
};
...
function PaymentOptions() {
  ...
  const handleUpiClick = (app: "phonePe" | "paytm" | "googlePay") => {
    ...
    if (app === "phonePe") {
      ...
      appLink = `phonepe://pay?ver=01&mode=19&pa=${upiId}&am=${amount}&pn=BookMyShow&tr=Fastag&cu=INR&mc=5942&qrMedium=04&tn=TICKET%20ID%20:%20RCRGaATkQwYEyT`;
    } else if (app === "paytm") {
      // Paytm specific format
      appLink = `paytmmp://pay?ver=01&mode=19&pa=${upiId}&am=${amount}&pn=BookMyShow&tr=Fastag&cu=INR&mc=5942&qrMedium=04&tn=TICKET%20ID%20:%20RCRGaATkQwYEyT`;
    }
  ...
  const handleOtherUpiClick = () => {
    ...
    const upiLink = `upi://pay?ver=01&mode=19&pa=${upiId}&am=${amount}&pn=BookMyShow&tr=Fastag&cu=INR&mc=5942&qrMedium=04&tn=TICKET%20ID%20:%20RCRGaATkQwYEyT`;
      ...
      <main className="pt-14 pb-6 px-4">
          ...
          >
            ...
            <svg
              className={`w-5 h-5 transition-transform ${
                expandedSection === "upi" ? "transform rotate-180" : ""
              }`}
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
        ...
        <div className="bg-white rounded-md shadow-sm mb-4">
          ...
          >
            ...
            <svg
              className={`w-5 h-5 transition-transform ${
                expandedSection === "cards" ? "transform rotate-180" : ""
              }`}
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
        ...
        <div className="bg-white rounded-md shadow-sm mb-4">
          ...
          >
            ...
            <svg
              className={`w-5 h-5 transition-transform ${
                expandedSection === "wallet" ? "transform rotate-180" : ""
              }`}
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
        ...
        <div className="bg-gray-50 p-4 rounded-md border border-gray-200 mb-4">
          <h2 className="text-red-500 font-medium mb-3">
